...
import { mdiMicrosoftWindows, mdiReact, mdiLanguageJavascript, mdiLanguageCss3, mdiHomeAssistant, mdiLanguageHtml5, mdiAws, mdiNodejs } from '@mdi/js';
    ...
    <div id='wrapper'>
      ...
      <div className="ring"></div>
        ...
        <div className='landingBox'>
          ...
          <div className="tooltip">
            <Icon path={mdiNodejs} className="svg-icon" color="var(--steelblue)"/>
            <span className="tooltiptext">Node.js</span>
          </div>
          <div className="tooltip">
            <Icon path={mdiAws} className="svg-icon" color="var(--steelblue)"/>
