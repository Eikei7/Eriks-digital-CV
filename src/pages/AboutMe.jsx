    ...
    <div className="aboutme-container">
      ...
      <div className="aboutme-content">
        ...
        <div className="aboutme-images">
          <img src="img/windows1.png" alt="Windows 1.0 screenshot" className="aboutme-image" />
          <img src="img/mario-nes.jpg" alt="Super Mario Bros NES" className="aboutme-image" />
        </div>
        
        <p>I chose these three events from my birth year for a reason. The reason being that, apart from growing up using Windows, I also love retro video games and music. Music is something I simply can't go without. I could talk for days about The Beatles' divine albums or John Mayer's incredible guitar playing, but that's not what this section was intended for.</p>
