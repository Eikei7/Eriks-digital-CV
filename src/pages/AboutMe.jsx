...
const AboutMe = () => {
  ...
  return (
    <div id='aboutmeWrapper'>
      ...
      <p>I was born in the year when the Live Aid concerts took place, Microsoft's Windows 1.0 was released and Super Mario Bros. on the NES was available in shops.</p>
